...
int main() {
	...
	switch(level) {
		case 1: height = 9; width = 9; num_mines = 10; num_flowers = 2; system("mode con: cols=53 lines=30"); break;
		case 2: height = 16; width = 16; num_mines = 40; num_flowers = 5; system("mode con: cols=80 lines=45"); break;
		case 3: height = 16; width = 30; num_mines = 99; num_flowers = 10; system("mode con: cols=140 lines=45"); break;
		default: break;
	}
	...
	while((win_or_lose = checkWin(cell,num_mines,height,width,life)) == 0){
		...
		cout << "0: sweep  1: marked as mine  2: unmark a cell  : ";
		cin >> op;
